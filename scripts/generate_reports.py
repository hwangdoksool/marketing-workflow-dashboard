...
ACTIONS_TIMELINE = {
    ...
    "W9": [
        ...
        {"date": "02-24", "action": "Meta ASC 캠페인 시작 — 기존 소재 20종 투입", "type": "📢 광고"},
    ...
    "W12": [
        ...
        {"date": "03-20", "action": "Meta 광고비 주 ₩138만 (최대 주간 — 스포엑스 부스트)", "type": "📢 광고"},
    ],
    "W13": [
        {"date": "03-23", "action": "마케팅 인텔리전스 리포트 v1~v5 작성", "type": "리포트"},
        {"date": "03-26~29", "action": "스포엑스 현장 (DP화면, 리더보드, 제안서, DP페이지)", "type": "현장"},
        {"date": "03-26", "action": "Meta 광고비 주 ₩106만 (스포엑스 기간 유지)", "type": "📢 광고"},
    ],
}
